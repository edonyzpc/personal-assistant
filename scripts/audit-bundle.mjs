...
// Hard release gate with bounded headroom above the current master build
// (2,953,626 gzip bytes on 2026-09-25; 34,816 bytes of headroom).
const DEFAULT_GZIP_BUDGET_BYTES = Math.ceil(2.85 * 1024 * 1024);
