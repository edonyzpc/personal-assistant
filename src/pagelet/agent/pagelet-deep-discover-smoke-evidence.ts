...
export interface PageletDeepDiscoverSmokeSnapshot {
    ...
    readonly runtimeCompletion: PageletAgentRuntimeCompletion | null;
...
function buildRawSnapshot(
    ...
    return Object.freeze({
        ...
        runtimeCompletion: "runtimeCompletion" in result
            ? result.runtimeCompletion ?? null
            : null,
        collectionId,
...
function freezeSnapshot(
    ...
    return Object.freeze({
        ...
        runtimeCompletion: snapshot.runtimeCompletion
            ? Object.freeze({
                ...snapshot.runtimeCompletion,
                diagnosticTypes: Object.freeze([
                    ...snapshot.runtimeCompletion.diagnosticTypes,
                ]),
            })
            : null,
