/**
 * @file This file contains utility functions for calculating statistics.
 ...
 * @param text - The string to count the words of.
 ...
 * @param text - The string to count the characters of.
...
/**
 * Gets the footnote count of a string.
 * @param text - The string to count the footnotes of.
 * @returns The footnote count.
 */
...
/**
 * Gets the citation count of a string.
 * @param text - The string to count the citations of.
 * @returns The citation count.
 */
...
/**
 * Gets the sentence count of a string.
 * @param text - The string to count the sentences of.
...
/**
 * Gets the page count of a string.
 * @param text - The string to count the pages of.
 * @param pageWords - The number of words per page.
...
/**
 * Cleans the comments from a string.
 * @param text - The string to clean the comments from.
