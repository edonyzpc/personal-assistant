...
export const READ_NOTE_MAX_READ_BYTES = 300_000;
export const READ_NOTE_RESULT_JSON_BUDGET_CHARS = 6000;
export const READ_NOTE_DEFAULT_MAX_CHARS = 3000;
export const READ_NOTE_MAX_CHARS = 4000;
export const QUERY_NOTES_DEFAULT_LIMIT = 10;
export const QUERY_NOTES_MAX_LIMIT = 20;
export const QUERY_NOTES_MAX_TAGS = 8;
export const QUERY_NOTES_MAX_PROPERTY_CONDITIONS = 8;
export const QUERY_NOTES_MAX_CANDIDATES = 500;
export const QUERY_NOTES_PROJECTION_MAX_UTF8_BYTES = 128_000;
export const QUERY_NOTES_RESULT_JSON_BUDGET_CHARS = 6000;
export const QUERY_NOTES_PATH_MAX_CHARS = 1024;
export const QUERY_NOTES_PROPERTY_KEY_MAX_CHARS = 256;
export const QUERY_NOTES_PROPERTY_VALUE_MAX_CHARS = 1024;
export const QUERY_NOTES_TAG_MAX_CHARS = 160;
export const QUERY_NOTES_CANONICAL_QUERY_MAX_CHARS = 4000;
export const QUERY_NOTES_CURSOR_MAX_CHARS = 4096;
...
export const INSPECT_NOTE_MAX_BACKLINK_SOURCES = 500;
...
export const SNIPPET_CURSOR_MAX_CHARS = 4096;
...
export const VAULT_FILE_STAT_UNAVAILABLE_SOURCE = "vault file stat unavailable";
export const NOTE_STRUCTURE_BODY_UNAVAILABLE_SOURCE = "note body read for task/callout text";
