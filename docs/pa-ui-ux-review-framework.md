...
| Related doctrine | [Low-Burden Review Product Principles](./pa-low-burden-review-product-principles.md) |
...
[Product North Star](./pa-product-north-star.md) as a rapid pass/fail gate:
