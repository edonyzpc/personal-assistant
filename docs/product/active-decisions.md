...
| --- | --- | --- | --- | --- |
| DEC-036 | PA Agent 基础能力与自主规划 | 取消 Operations/Memory 规划性开放门；日期由主 Agent 选择并说明，不确定时询问；保留来源、确认与治理规则 | [Decision](./decisions/dec-036-pa-agent-essential-capabilities.md), [Product Spec](./specs/pa-agent-essential-capabilities-product-spec.md) | 基础组合不足或必须改变权限/数据边界 |
