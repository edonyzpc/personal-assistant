...
| --- | --- | --- | --- | --- |
| DEC-038 | Chat image generation and unified image connection | Accepted | Wan 创建/参考/编辑、后台恢复、确切版本与复制下载；Chat/Featured Image 统一连接；产品范围确认，实施另行授权 | [Record](./dec-038-chat-image-generation.md) |
