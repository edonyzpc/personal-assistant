...
| DEC-027 | Bounded, convergence-aware retrieval recovery | Accepted | Owner-selected `CHAR-PHRASE` profile；bounded rerank/PPR/retry；B-125 software proxy、Win32 scoped exclusion and current-iPhone compact performance gate；extended certification in B-126 | [Record](./dec-027-bounded-retrieval-recovery.md) |
