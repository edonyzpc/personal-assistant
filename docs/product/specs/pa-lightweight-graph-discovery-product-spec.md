...
| Status | Bounded M12 Graph Discovery is the current product contract；DEC-027/B-125 defines the implemented scoped opaque-bridge retrieval amendment. B-125 implementation/validation and per-flag rollout dispositions are closed in its [compact evidence](../../archive/2026/b-125-retrieval-optimization-closeout.md). |
...
a scoped retrieval contract；its completed execution and rollout evidence remains
historical and does not become product authority in this spec.
