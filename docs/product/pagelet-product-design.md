...
Implementation、validation and rollout state is recorded only in the
[B-125 Tracker](../development/active/retrieval-optimization/tracker.md)；this
product design does not mirror that delivery status.
