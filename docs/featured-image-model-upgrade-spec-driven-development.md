...
| --- | --- | --- |
| `docs/featured-image-model-upgrade-plan.md` | Contract source of truth for product behavior, runtime protocol, settings, endpoint mapping, failure handling, and speed/cost wording. | This wins for product, runtime, settings, and failure semantics. |
| `docs/featured-image-model-upgrade-spec-driven-development.md` | Active SPEC-driven implementation tracker for task slicing, execution status, review records, verification evidence, and closeout. | This wins for implementation state and evidence. If it drifts from the plan, update both docs in the same reviewed change before implementation continues. |
...
| --- | --- |
| Created | 2026-05-17 |
| Contract source | `docs/featured-image-model-upgrade-plan.md` |
...
- Add `docs/featured-image-model-upgrade-plan.md`.
- Add `docs/featured-image-model-upgrade-spec-driven-development.md`.
...
- `git diff --check -- docs/featured-image-model-upgrade-plan.md docs/featured-image-model-upgrade-spec-driven-development.md`

Verification record:

| Date | Command | Result | Notes |
| --- | --- | --- | --- |
| 2026-05-17 | `rg -n "[[:blank:]]+$" docs/featured-image-model-upgrade-plan.md docs/featured-image-model-upgrade-spec-driven-development.md` | Passed | No trailing whitespace in the untracked docs creation pass. |
| 2026-05-17 | `rg -n "[[:blank:]]+$" docs/featured-image-model-upgrade-plan.md docs/featured-image-model-upgrade-spec-driven-development.md` | Passed | Re-run after architecture and senior-engineer review fixes. |
