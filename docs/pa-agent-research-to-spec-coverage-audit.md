...
| Primary specs audited | [Product IA](./pa-product-information-architecture-spec.md), [Quick Capture](./pa-quick-capture-micronote-product-spec.md), [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md), [Trust Layer](./pagelet-trust-layer-product-spec.md), [Maintenance Review](./pagelet-maintenance-review-product-spec.md), [Lightweight Graph Discovery](./pa-lightweight-graph-discovery-product-spec.md), [Data Boundary](./pa-data-boundary-product-spec.md), [Eval Harness](./pa-eval-harness-product-spec.md) |
...
| --- | --- | --- | --- |
| Capture before intelligence | Covered | [Quick Capture](./pa-quick-capture-micronote-product-spec.md) | No immediate gap. |
| Original notes are sacred | Covered | [Quick Capture](./pa-quick-capture-micronote-product-spec.md), [Maintenance Review](./pagelet-maintenance-review-product-spec.md), [Trust Layer](./pagelet-trust-layer-product-spec.md) | Keep source-note mutation behind preview / diff / undo in SDDs. |
| Evidence before eloquence | Covered | [Trust Layer](./pagelet-trust-layer-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md), [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md) | No immediate gap. |
| Memory is layered: Raw / Index / Derived / Confirmed | Covered | [Trust Layer](./pagelet-trust-layer-product-spec.md), [Product IA](./pa-product-information-architecture-spec.md), [Data Boundary](./pa-data-boundary-product-spec.md) | Memory type taxonomy may still need a separate decision pass. |
...
| Retrieval is a router, not top-k | Covered | [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md) | Recap/theme lanes deferred; see separate row. |
| No-answer / partial / conflict retrieval outcomes | Covered | [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md), [Eval Harness](./pa-eval-harness-product-spec.md) | No immediate gap. |
| Broad retrieval should be plan-first | Covered | [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md), [Data Boundary](./pa-data-boundary-product-spec.md) | Needs future SDD detail. |
| Graph should be background index first | Covered | [Lightweight Graph Discovery](./pa-lightweight-graph-discovery-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md) | No full graph product for now. |
| Use user structure before AI ontology | Covered | [Lightweight Graph Discovery](./pa-lightweight-graph-discovery-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md) | No immediate gap. |
| Quiet UX beats autonomous theater | Covered | [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md), [Product IA](./pa-product-information-architecture-spec.md), [Pagelet product design](./pagelet-product-design.md) | No immediate gap. |
...
| Local-first means explicit data boundaries | Covered | [Data Boundary](./pa-data-boundary-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md), [Quick Capture](./pa-quick-capture-micronote-product-spec.md), [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md) | No immediate gap. |
| Evaluation is a product feature | Covered | [Eval Harness](./pa-eval-harness-product-spec.md) | Future SDD should define first fixture files and CLI. |
| Chat is not the center | Covered | [Product IA](./pa-product-information-architecture-spec.md) | No immediate gap. |
| Pagelet is primary review surface | Covered | [Product IA](./pa-product-information-architecture-spec.md), [Maintenance Review](./pagelet-maintenance-review-product-spec.md), [Trust Layer](./pagelet-trust-layer-product-spec.md) | No immediate gap. |
| Review Queue is shared and typed | Covered | [Product IA](./pa-product-information-architecture-spec.md), [Trust Layer](./pagelet-trust-layer-product-spec.md), [Maintenance Review](./pagelet-maintenance-review-product-spec.md), [Quick Capture](./pa-quick-capture-micronote-product-spec.md), [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md) | Future SDD should avoid creating separate per-feature queues. |
| Low-frequency recall with evidence | Covered | [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md), [Trust Layer](./pagelet-trust-layer-product-spec.md) | No immediate gap. |
| Insight must have evidence, delta, and next action | Covered | [Saved Insight and Insight Ledger](./pa-saved-insight-ledger-product-spec.md), [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md), [Trust Layer](./pagelet-trust-layer-product-spec.md) | No immediate gap. |
| Weekly Review / Pagelet Review compounds value | Covered | [Weekly Review](./pa-weekly-review-product-spec.md), [Maintenance Review](./pagelet-maintenance-review-product-spec.md), [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md), [Eval Harness](./pa-eval-harness-product-spec.md), [Pagelet product design](./pagelet-product-design.md) | No immediate gap. |
| Folder/project recap and hierarchical summaries | Covered | [Scope Recap and Theme Summary](./pa-scope-recap-theme-summary-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md) Phase 8 | No immediate gap. |
| Theme/community summaries | Covered | [Scope Recap and Theme Summary](./pa-scope-recap-theme-summary-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md), [Quiet Recall](./pa-quiet-recall-insight-timing-product-spec.md), [Lightweight Graph Discovery](./pa-lightweight-graph-discovery-product-spec.md) | No immediate gap. |
| Retrieval Habit Profile | Covered | [Retrieval Habit Profile](./pa-retrieval-habit-profile-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md), [Data Boundary](./pa-data-boundary-product-spec.md) | No immediate gap. |
| Context Pager / context packing UX | Covered | [Context Pager](./pa-context-pager-product-spec.md), [Trust Layer](./pagelet-trust-layer-product-spec.md), [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md), existing context runtime docs | No immediate gap. |
| Memory profile / user model boundary | Covered | [Memory Type Taxonomy](./pa-memory-type-taxonomy-product-spec.md), [Trust Layer](./pagelet-trust-layer-product-spec.md), [Data Boundary](./pa-data-boundary-product-spec.md) | No immediate gap. |
| Mobile / voice capture | Deferred but acknowledged | [Quick Capture](./pa-quick-capture-micronote-product-spec.md) | No v1 work; revisit after desktop capture is validated. |
...
| Full Personal Knowledge Graph | Intentionally not covered | [Lightweight Graph Discovery](./pa-lightweight-graph-discovery-product-spec.md) rejects it for MVP | Keep out of near-term roadmap. |
...
| Whole-vault long-context prompting | Intentionally not covered | [Active Vault Indexer](./pa-active-vault-indexer-product-spec.md) favors retrieval/router | Keep out of product strategy. |
...
| All personal data integration on day one | Intentionally not covered | [Data Boundary](./pa-data-boundary-product-spec.md) limits scope | Defer connectors until vault core is trustworthy. |
...
Status: covered by [PA Saved Insight And Insight Ledger Product Spec](./pa-saved-insight-ledger-product-spec.md).
...
Status: covered by [PA Scope Recap And Theme Summary Product Spec](./pa-scope-recap-theme-summary-product-spec.md).
...
Status: covered by [PA Memory Type Taxonomy And Profile Boundary Product Spec](./pa-memory-type-taxonomy-product-spec.md).
...
Status: covered by [PA Retrieval Habit Profile Product Spec](./pa-retrieval-habit-profile-product-spec.md).
...
Status: covered by [PA Context Pager Product Spec](./pa-context-pager-product-spec.md).
