...
| Related product docs | [Low-Burden Review Principles](./pa-low-burden-review-product-principles.md), [Information Architecture Spec](./pa-product-information-architecture-spec.md) |
...
- `docs/pa-weekly-review-product-spec.md` — archive (add deprecated header)
- `docs/pa-product-information-architecture-spec.md` — remove weekly review
  references
- `docs/pa-active-vault-indexer-product-spec.md` — remove cross-reference
