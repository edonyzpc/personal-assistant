...
The verified map is in `02-architecture.md`. Key ownership boundaries used by
...
back. Every task has a detailed ledger under `tasks/`, `reviews/`, and
`verification/`.
...
No introduced P0/P1/P2 remains. Full details and residuals are in
...
- Concurrent out-of-scope workspace changes discovered at `18:01:59+08:00`:
  `docs/pa-memory-control-center-optimization-plan.md` plus its links in
  `docs/index.md` and `docs/todo.md`. They form a coherent future-product intake,
...
- Intentional optimization additions: `.github/workflows/ci.yml` and
  40 files under `docs/optimization/`.
...
- Task-specific rollback instructions are in `tasks/OPT-001.md` through
  `tasks/OPT-010.md`.
