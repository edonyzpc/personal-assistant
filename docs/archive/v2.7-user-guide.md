...
更详细的 Pagelet 操作步骤见 [Pagelet 使用指南](../guides/pagelet-user-guide.md)。
...
- AI Chat / Personal Assistant 演示：`docs/assets/Personal-Assitant-With-AI.gif`
- AI 生成特色图演示：`docs/assets/featured-images-ai-generation.mp4`
- 历史操作演示：`docs/assets/personal-assistant-v1.3.6.gif`、`docs/assets/personal-assistant-v1.3.3.gif`
