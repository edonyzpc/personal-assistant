...
- [x] Close Pagelet release verification for the v2.7 consolidated release.
  ...
  - Source: [`development-roadmap.md`](./development-roadmap-v2.7.md) v2.2 section, SPEC-B1/B2 in [`v2-post-release-spec-driven-development.md`](./v2-post-release-spec-driven-development.md).
...
- [x] Fix structured vault tool argument extraction exposed by broad PA Agent desktop smoke.
  ...
  - Source docs: `docs/archive/pa-agent-design-completion-audit.md`.
...
- [x] Close PA Agent v1 development release gates.
  ...
  - Source docs: `docs/archive/pa-agent-design-completion-audit.md`; `docs/architecture/pa-agent-architecture-plan.md`; `docs/archive/pa-agent-product-safety-review.md`; `docs/architecture/pa-agent-runtime-lifecycle-plan.md`; `docs/operations/pa-agent-telemetry-baseline.md`.
...
- [ ] Review and scope write action / command execution product and security design.
  ...
  - Source docs: `docs/development/proposals/operations-agent/operations-agent-plan.md`; `docs/archive/write-action-design-handoff.md`; [`development-roadmap.md`](./development-roadmap-v2.7.md) v2.5 section; SPEC-C1 in [`v2-post-release-spec-driven-development.md`](./v2-post-release-spec-driven-development.md).
...
- [ ] Collect post-ship PA Agent v1 telemetry baseline before using usage data for Operations Agent prioritization.
  ...
  - Source docs: `docs/operations/pa-agent-telemetry-baseline.md`; `docs/archive/pa-agent-design-completion-audit.md`.
...
- [x] Complete real iPhone mobile WebSearch cancellation/recovery validation after enabling mobile export.
  ...
  - Source docs: `docs/archive/pa-agent-design-completion-audit.md`; `docs/architecture/pa-agent-architecture-plan.md`.
...
- [x] Complete RAG Phase 3: Query Rewrite + LLM Reranker.
  ...
  - Source docs: [`rag-hybrid-retrieval-plan.md`](./rag-hybrid-retrieval-plan.md).
...
- [x] Close PA Agent v1 runtime lifecycle external verification gates.
  ...
  - Evidence: `docs/architecture/pa-agent-runtime-lifecycle-plan.md`; `docs/archive/pa-agent-design-completion-audit.md`; final closeout checks `npm test -- --runInBand`, `npm run lint`, `npm run build`, and `git diff --check`.
