...
- [ ] Review and scope write action / command execution product and security design.
  ...
  - Source docs: `docs/operations-agent-plan.md`; `docs/write-action-design-handoff.md`; [`development-roadmap.md`](./development-roadmap-v2.7.md) v2.5 section; SPEC-C1 in [`v2-post-release-spec-driven-development.md`](./v2-post-release-spec-driven-development.md).
