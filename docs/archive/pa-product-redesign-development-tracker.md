...
- **Status**: `[x]`
- **File**: `docs/product/pa-product-north-star.md`
- **Scope**:
...
- **Acceptance**:
  - The old English short form no longer appears in `docs/product/pa-product-north-star.md`
...
- **Status**: `[x]`
- **Files**: `docs/product/specs/pa-quiet-recall-insight-timing-product-spec.md`,
  `docs/archive/pa-weekly-review-product-spec.md`,
  `docs/product/pagelet-product-design.md`
- **Scope**:
...
- **Spec refs**:
  [pagelet-delivery-preparation-consolidation-product-note.md](../product/specs/pagelet-delivery-preparation-consolidation-product-note.md)
- **Status**: `[D]`
- **Scope**:
...
- **Spec refs**:
  [pagelet-bubble-readiness-and-recall-product-spec.md](../product/specs/pagelet-bubble-readiness-and-recall-product-spec.md)
  § 3.3
- **Status**: `[D]`
- **Scope**:
...
|------|------------|--------------------|--------------------|----------------|-------|
| 2026-07-02 | Phase 0 / P0.1-P0.3 | New North Star in `docs/product/pa-product-north-star.md`, `AGENTS.md`, and `CLAUDE.md`; affected specs have top callouts | Old English short-form grep returned no output; `git diff --check` passed | N/A | Runtime work remains gated until subsequent phase prerequisites are met |
