...
<div align="center">
  <img src="../assets/Personal-Assitant-With-AI.gif" alt="Personal Assistant AI Chat demo" />
</div>
...
For detailed Pagelet steps, see the [Pagelet user guide](../guides/pagelet-user-guide.md).

### Existing Media Assets

These assets can be reused in README, release notes, or the release page:

- AI Chat / Personal Assistant demo: `docs/assets/Personal-Assitant-With-AI.gif`
- AI featured image generation demo: `docs/assets/featured-images-ai-generation.mp4`
- Historical workflow demos: `docs/assets/personal-assistant-v1.3.6.gif`,
  `docs/assets/personal-assistant-v1.3.3.gif`
