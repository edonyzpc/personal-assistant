...
| 2026-07-12 | `docs/pagelet-product-design.md` | absorbed | [Pagelet Product Design](../product/pagelet-product-design.md) | 文档重组后继续由 product 目录下的同名 current contract 承接；B-108 更新保留其产品边界与设计连续性 |
| 2026-07-19 | `docs/development/active/pagelet-b108-dogfood-followup/README.md` | absorbed | [Archived B-108 Feature Home](./2026/pagelet-b108-dogfood-followup/README.md) | Active Feature Home 在 closeout 时加入终态和 BRAT 交付证据后移入年度 Archive；原有范围、authority 与 traceability 已连续承接 |
| 2026-07-19 | `docs/development/handoff-pagelet-v29-validation.md` | absorbed | [Archived B-108 Validation Handoff](./2026/pagelet-b108-dogfood-followup/handoff-pagelet-v29-validation.md) | 正式验证清单、物理证据边界、provider smoke 与最终 BRAT 结果在 closeout 后由同一归档文档连续承接，不再作为当前待执行 handoff |
| 2026-07-20 | `docs/development/discovery/insight-enhancement-layer.md` | absorbed | [B-119 accepted discovery summary](../development/active/insight-enhancement-layer/discovery.md) | 原始问题、repo 证据、方案和讨论结论进入 Active Package；过期的四功能范围与实现假设被明确标为 superseded |
| 2026-07-20 | `docs/development/discovery/insight-enhancement-layer-codex-handoff.md` | absorbed | [B-119 current Codex handoff](../development/active/insight-enhancement-layer/handoff-codex.md) | 迁移到 Active Package，并按 DEC-022 删除 Writing phase、修正 provider/host/DTO/成本与 Maintenance 写入边界 |
