...
The full Settings IA simplification and complete componentization are not done. Keep this file as a historical target design; use `docs/archive/settings-ui-review.md` and `docs/v2-fix-plan.md` for current fixed/partial/open status.
