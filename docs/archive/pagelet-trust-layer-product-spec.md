...
> **Archived 2026-07-11:** inactive broader product proposal. Current Memory
> governance is owned by [Memory Control Center](../product/specs/pa-memory-control-center-product-spec.md);
> current Pagelet behavior is owned by [Pagelet Product Design](../product/pagelet-product-design.md).
...
| Related retrieval substrate | [PA Active Vault Indexer spec](../product/specs/pa-active-vault-indexer-product-spec.md) |
| Related Pagelet docs | [Pagelet product design](../product/pagelet-product-design.md), [PA Product Information Architecture spec](../product/pa-product-information-architecture-spec.md), [Quick Capture and Micronote spec](../product/specs/pa-quick-capture-micronote-product-spec.md), [Quiet Recall and Insight Timing spec](../product/specs/pa-quiet-recall-insight-timing-product-spec.md), [Saved Insight and Insight Ledger spec](../product/specs/pa-saved-insight-ledger-product-spec.md), [Memory Type Taxonomy spec](../product/specs/pa-memory-type-taxonomy-product-spec.md), [Context Pager spec](../product/specs/pa-context-pager-product-spec.md), [Weekly Review spec](./pa-weekly-review-product-spec.md), [Pagelet Maintenance Review spec](./pagelet-maintenance-review-product-spec.md), [Lightweight Graph Discovery spec](../product/specs/pa-lightweight-graph-discovery-product-spec.md), [PA Eval Harness spec](../product/specs/pa-eval-harness-product-spec.md), [PA Data Boundary spec](../product/specs/pa-data-boundary-product-spec.md), [Pagelet async result plan](./pagelet-async-result-plan.md) |
| Related Memory docs | [VSS local state plan](../architecture/vss-local-state-plan.md), [SQLite/WASM architecture](../architecture/vss-sqlite-wasm-architecture.md), [Embedding refresh](../architecture/vss-embedding-refresh.md) |
...
set lives in [PA Product Information Architecture](../product/pa-product-information-architecture-spec.md);
