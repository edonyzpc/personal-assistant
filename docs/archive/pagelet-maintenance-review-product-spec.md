...
> **Archived 2026-07-11:** inactive broader maintenance proposal. Current
> bounded maintenance behavior remains in Pagelet and the Write Action
> Framework; broader actions require a new product/security gate.
...
| Related Pagelet docs | [Pagelet product design](../product/pagelet-product-design.md), [PA Product Information Architecture spec](../product/pa-product-information-architecture-spec.md), [Quiet Recall and Insight Timing spec](../product/specs/pa-quiet-recall-insight-timing-product-spec.md), [Saved Insight and Insight Ledger spec](../product/specs/pa-saved-insight-ledger-product-spec.md), [Weekly Review spec](./pa-weekly-review-product-spec.md), [Pagelet Trust Layer spec](./pagelet-trust-layer-product-spec.md), [PA Eval Harness spec](../product/specs/pa-eval-harness-product-spec.md), [PA Data Boundary spec](../product/specs/pa-data-boundary-product-spec.md), [Pagelet async result plan](./pagelet-async-result-plan.md), [Pagelet user guide](../guides/pagelet-user-guide.md) |
| Related write boundary | [Write Action Framework SDD](../architecture/write-action-framework-sdd.md), [Write action handoff](./write-action-design-handoff.md), [Operations Agent boundary](../development/proposals/operations-agent/operations-agent-plan.md), [Operations Agent mode SDD](../development/proposals/operations-agent/operations-agent-mode-sdd.md) |
