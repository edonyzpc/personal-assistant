...
| Product source of truth | [PA Product North Star](../product/pa-product-north-star.md), [Low-Burden Review Product Principles](../product/pa-low-burden-review-product-principles.md) |
...
- Audit `docs/archive/pa-agent-product-spec-review-plan.md` while it remains a root doc:
