...
The v2.7-specific release video has not been recorded yet. A recording script is
included near the end of this guide so the release can use a real video once it
exists.
...
| --- | --- | --- |
| Find related ideas | Discovery | Read connection-style cards |
