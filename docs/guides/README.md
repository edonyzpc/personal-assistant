...
- [图片聊天与图文保存](./multimodal-chat-user-guide.md) — B-129 构建的图片入口、版本保存、风格参考及同步设置。
...
v2.7 版本化指南已经归档：[中文](../archive/v2.7-user-guide.md) / [English](../archive/v2.7-user-guide-en.md)。版本化指南仅用于历史复现，不是当前行为权威。
