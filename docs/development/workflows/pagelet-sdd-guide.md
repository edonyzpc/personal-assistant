...
The interactive prototype at `docs/archive/assets/pagelet-prototype.html` is a historical visual reference. Its older Bubble degrade/restore behavior is superseded by the current click-outside close contract above. It still demonstrates:
