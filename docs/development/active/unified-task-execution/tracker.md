...
- 实际宿主为 Obsidian 2.9.2；部署 bundle SHA256 `0fb0aba1e069086ec821f979fba9749d0d82146d8d8082b19327610705a4d684`，对应生产源码提交 `0bbe12ba4313ae537990d3d5208496f3c12bc312`。其后提交至本次输入只改 tests/docs，未改变生产源码、配置、依赖或 build；因此复用该明确构建身份，不把当前分支 HEAD 本身当部署证明。
