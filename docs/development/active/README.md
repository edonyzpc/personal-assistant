...
| Pagelet UI/UX optimization | B-118 | Planned | Desktop/iPhone UI hardening; no release commitment | 2026-07-19 | [Feature Home](./pagelet-ui-ux-optimization/README.md) / [Tracker](./pagelet-ui-ux-optimization/tracker.md) |
