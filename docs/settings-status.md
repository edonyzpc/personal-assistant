...
| Current source of truth | Current code plus the status table in [Settings UI Review](./settings-ui-review.md) |
...
[Settings UI Review](./settings-ui-review.md) is retained as evidence and
