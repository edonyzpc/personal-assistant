...
| Primary inputs | `docs/pa-product-north-star.md`, `docs/pa-agent-product-spec-development-plan.md`, `docs/pa-agent-product-spec-development-tracker.md`, current git diff |
...
- untracked areas: PA eval fixtures, new PA-focused tests,
  `docs/pa-agent-product-spec-development-tracker.md`, `src/pa/*`,
...
- `docs/pa-agent-product-spec-development-plan.md` and tracker agree on what is
