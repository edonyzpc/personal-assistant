...
1. `docs/pagelet-tab-restructure-plan.md` — 完整设计决策和依赖图
2. `docs/pa-product-north-star.md` — 产品北极星
3. `docs/pa-low-burden-review-product-principles.md` — 低负担审查原则
4. `docs/pa-product-information-architecture-spec.md` — 多表面路由
...
- `src/custom.pcss`（修改）
- `docs/pa-weekly-review-product-spec.md`（修改：添加 deprecated header）
- `docs/pa-product-information-architecture-spec.md`（修改）
- `docs/pa-active-vault-indexer-product-spec.md`（修改：移除 weekly review
  交叉引用）
