...
describe('LLMView turn lifecycle', () => {
    ...
    it('keeps @CreateImage selection separate from IME confirmation and #skill completion', async () => {
        ...
        Object.assign(area, { selectionStart: 4, selectionEnd: 4 });
        area.dispatchEvent('input');
        const enterEvent = { key: 'Enter', isComposing: false, keyCode: 13, preventDefault: jest.fn() };
        area.dispatchEvent('keydown', enterEvent);
        ...
        area.dispatchEvent('keydown', escapeEvent);
